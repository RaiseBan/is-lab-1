...
public class JwtService {
    ...
    public String generateToken(Map<String, Object> extraClaims, UserDetails userDetails) {
        return Jwts.builder()
                ...
                .setExpiration(new Date(System.currentTimeMillis() + 1000 * 60 * 60 * 10))  // Время истечения (10 часов)
                .signWith(getSigningKey(), SignatureAlgorithm.HS256)  // Подписываем токен с использованием ключа
